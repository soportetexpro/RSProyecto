 ...
 *   MAIL_CLIENT_SECRET — Client secret de Azure AD
 *   MAIL_FROM_ADDRESS  — Buzón remitente (ej: soporte@texpro.cl)
...
/**
 * Envía un correo OTP usando Microsoft Graph API
 * @param {string} destinatario — email del destinatario
 * @param {string} codigo       — código OTP a enviar
 */
